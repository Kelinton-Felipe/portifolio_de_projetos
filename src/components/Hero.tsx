  ...
  return <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        duration: 0.8
          ...
          delay: 0.3
        }} className="text-accent font-medium mb-4 tracking-wide">Olá, eu sou o</motion.p>
          ...
          delay: 0.5
        }} className="text-5xl md:text-7xl font-bold mb-6 bg-text-gradient bg-clip-text text-transparent">Kelinton Felipe</motion.h1>
          ...
          delay: 1.2
            ...
            <Button size="lg" onClick={() => scrollToSection('projects')} className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 text-lg font-medium shadow-primary hover:shadow-glow transition-all duration-normal hover:scale-105">
              Ver Projetos
            </Button>
        ...
        delay: 2
          ...
          <motion.button onClick={() => scrollToSection('projects')} className="text-muted-foreground hover:text-primary transition-colors" animate={{
          y: [0, 10, 0]
        }} transition={{
          duration: 2,
          repeat: Infinity
